...
if (ch.hair_color === "none") {
  console.log(`${pronoun} has no hair.`);
} else if (ch.hair_color !== "n/a") {
...
console.log(`${pronoun} has ${ch.eye_color} eyes.`);

console.log(`${possessive} date of birth is ${ch.birth_year}.`);
